...
import {
    ...
    CarouselSlot,
    SlideButton,
} from '../../components/TinderCard/carousel-components';
// icons
...
// types 
import { NEXT, PREV, Direction, CarouselAction } from '../../lib/types';
...
const TinderRecommendation = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center w-full" {...handlers}>
            <div className="w-full md:w-1/2 h-[480px] overflow-hidden shadow-lg">
                        ...
                        >
                            {
                                loading ? (
                                    ...
                                    state.pos <= -1 ? (
                                        ...
                                        <div className="flex flex-col p-[48px] w-full rounded-xl bg-cover " style={{}}>
                                            <div className="flex justify-between items-center">
                                                <div className="">
                                                    <h1 className='text-md'>{user.gender}</h1>
                                                    <h1 className='text-lg font-semibold'>{user.name}</h1>
                                                </div>
                                                <div className="">
                                                    <h1 className='text-md font'>{user.location}</h1>
                                                    <h1 className='text-lg font-semibold'>{user.interests.join(", ")}</h1>
                                                </div>
                                            </div>
                                        </div>
                                    )
            ...
            <div className='flex justify-between items-center space-x-8 pb-4'>
                ...
                </SlideButton>
                {
                    <h1 className={
                        clsx(
                            "w-[64px] text-2xl transition ease-in-out duration-300",
...
export default TinderRecommendation;